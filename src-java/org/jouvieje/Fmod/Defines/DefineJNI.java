...
class DefineJNI
{
	...
	protected final static native float get_FMOD_VERSION();
	protected final static float get_NATIVEFMOD_JAR_VERSION()
	{
		return 3.4f;		//TODO NativeFmod version
	}
	protected final static native float get_NATIVEFMOD_LIBRARY_VERSION();
}