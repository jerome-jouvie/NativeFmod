 ...
 * FSOUND_OUTPUTTYPES
 */
public interface FSOUND_CAPS
{
	/**This driver supports hardware accelerated 3d sound.*/
	public final static int FSOUND_CAPS_HARDWARE = 0x1;
	/**This driver supports EAX 2 reverb*/
	public final static int FSOUND_CAPS_EAX2 = 0x2;
	/**This driver supports EAX 3 reverb*/
	public final static int FSOUND_CAPS_EAX3 = 0x10;
}