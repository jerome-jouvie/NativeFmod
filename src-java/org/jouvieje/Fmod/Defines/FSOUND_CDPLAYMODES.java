 ...
 */
public interface FSOUND_CDPLAYMODES
{
	/**Starts from the current track and plays to end of CD.*/
	public final static int FSOUND_CD_PLAYCONTINUOUS = 0;
	/**Plays the specified track then stops.*/
	public final static int FSOUND_CD_PLAYONCE = 1;
	/**Plays the specified track looped, forever until stopped manually.*/
	public final static int FSOUND_CD_PLAYLOOPED = 2;
	/**Plays tracks in random order*/
	public final static int FSOUND_CD_PLAYRANDOM = 3;
}