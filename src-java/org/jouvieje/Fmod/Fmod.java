...
/**
 * Provides access to Fmod methods
 */
public class Fmod extends Pointer implements FMOD_CONSTANTS {
	private Fmod(){}
	 ...
	 */
	public static boolean FSOUND_CD_Eject(char drive) {
		return FmodJNI.FSOUND_CD_Eject(drive);
	}
	 ...
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_GetDriverCaps(int, IntBuffer)
	 * @see Fmod#FSOUND_GetOutput()
	 * @see Fmod#FSOUND_GetOutputHandle()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see FSOUND_OUTPUTTYPES
	 * @see Fmod#FSOUND_SetDriver(int)
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static boolean FSOUND_SetOutput(int outputtype)
	{
		return FmodJNI.FSOUND_SetOutput(outputtype);
	}
	/**
	 ...
	 * On failure, (ie if FMOD is already active) FALSE is returned.
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_GetDriver()
	 * @see Fmod#FSOUND_GetDriverName(int)
	 * @see Fmod#FSOUND_GetNumDrivers()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static boolean FSOUND_SetDriver(int driver)
	{
		return FmodJNI.FSOUND_SetDriver(driver);
	}
	 ...
	 * On failure, (ie if FMOD is already active) FALSE is returned.
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_DSP_GetBufferLengthTotal()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 */
	public static boolean FSOUND_SetBufferSize(int len_ms)
	{
		return FmodJNI.FSOUND_SetBufferSize(len_ms);
	}
	 ...
	 * @see Fmod#FSOUND_Init(int, int, int)
	 */
	public static boolean FSOUND_SetHWND(Pointer hwnd)
	{
		return FmodJNI.FSOUND_SetHWND(Pointer.getPointer(hwnd));
	}
	 ...
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_SetMaxHardwareChannels(int)
	 */
	public static boolean FSOUND_SetMinHardwareChannels(int min)
	{
		return FmodJNI.FSOUND_SetMinHardwareChannels(min);
	}
	 ...
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_SetMaxHardwareChannels(int)
	 * @see Fmod#FSOUND_SetMinHardwareChannels(int)
	 */
	public static boolean FSOUND_SetMaxHardwareChannels(int max)
	{
		return FmodJNI.FSOUND_SetMaxHardwareChannels(max);
	}
	 ...
	 * @see Fmod#FSOUND_GetMemoryStats(IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see FSOUND_REALLOCCALLBACK
	 */
	public static boolean FSOUND_SetMemorySystem(ByteBuffer pool, int poollen,
			...
			FSOUND_FREECALLBACK userfree)
	{
		...
		return FmodJNI.FSOUND_SetMemorySystem(pool, BufferUtils.getPositionInBytes(pool), poollen,
				useralloc, userrealloc, userfree);
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_File_SetCallbacks(FSOUND_OPENCALLBACK, FSOUND_CLOSECALLBACK, FSOUND_READCALLBACK, FSOUND_SEEKCALLBACK, FSOUND_TELLCALLBACK)
	 * @see Fmod#FSOUND_GetCurrentLevels(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_GetDriverCaps(int, IntBuffer)
	 * @see Fmod#FSOUND_GetMaxChannels()
	 * @see Fmod#FSOUND_GetMemoryStats(IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_GetOutputHandle()
	 * @see Fmod#FSOUND_GetOutputRate()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see FSOUND_INIT_FLAGS
	 * @see Fmod#FSOUND_PlaySound(int, FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_PlaySoundEx(int, FSOUND_SAMPLE, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_SetBufferSize(int)
	 * @see Fmod#FSOUND_SetDriver(int)
	 * @see Fmod#FSOUND_SetHWND(Pointer)
	 * @see Fmod#FSOUND_SetMaxHardwareChannels(int)
	 * @see Fmod#FSOUND_SetMemorySystem(ByteBuffer, int, FSOUND_ALLOCCALLBACK, FSOUND_REALLOCCALLBACK, FSOUND_FREECALLBACK)
	 * @see Fmod#FSOUND_SetMinHardwareChannels(int)
	 * @see Fmod#FSOUND_SetMixer(int)
	 * @see Fmod#FSOUND_SetOutput(int)
	 * @see Fmod#FSOUND_SetSpeakerMode(int)
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 */
	public static boolean FSOUND_Init(int mixrate, int maxsoftwarechannels, int flags)
	{
		return FmodJNI.FSOUND_Init(mixrate, maxsoftwarechannels, flags);
	}
	 ...
	 * ___________________<br>
	 * Supported on the following platforms : Win32, WinCE, Linux, Macintosh, XBox, PlayStation 2, GameCube
	 * @see Fmod#FSOUND_CD_GetVolume(char)
	 * @see Fmod#FSOUND_CD_SetVolume(char, int)
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_Sample_Alloc(int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_Get(int)
	 * @see Fmod#FSOUND_Sample_Load(int, String, int, int, int)
	 * @see Fmod#FSOUND_SetBufferSize(int)
	 * @see Fmod#FSOUND_SetDriver(int)
	 * @see Fmod#FSOUND_SetHWND(Pointer)
	 * @see Fmod#FSOUND_SetMaxHardwareChannels(int)
	 ...
	 * ___________________<br>
	 * Supported on the following platforms : Win32, WinCE, Linux, Macintosh, XBox, PlayStation 2, GameCube
	 * @see Fmod#FSOUND_3D_Listener_SetAttributes(FloatBuffer, FloatBuffer, float, float, float, float, float, float)
	 * @see Fmod#FSOUND_3D_Listener_SetCurrent(int, int)
	 * @see Fmod#FSOUND_3D_SetAttributes(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_SetDopplerFactor(float)
	 */
	public static void FSOUND_Update()
	{
		FmodJNI.FSOUND_Update();
	}
	 ...
	 * @see Fmod#FSOUND_Close()
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_SetPanSeperation(float)
	 * @see FSOUND_SPEAKERMODES
	 */
	public static void FSOUND_SetSpeakerMode(int speakermode)
	{
		FmodJNI.FSOUND_SetSpeakerMode(speakermode);
	}
	 ...
	 * @see Fmod#FMUSIC_SetMasterVolume(FMUSIC_MODULE, int)
	 * @see Fmod#FSOUND_SetVolume(int, int)
	 * @see Fmod#FSOUND_SetVolumeAbsolute(int, int)
	 */
	public static void FSOUND_SetSFXMasterVolume(int volume)
	{
		FmodJNI.FSOUND_SetSFXMasterVolume(volume);
	}
	 ...
	 * @see Fmod#FMUSIC_SetPanSeperation(FMUSIC_MODULE, float)
	 * @see Fmod#FSOUND_SetSpeakerMode(int)
	 */
	public static void FSOUND_SetPanSeperation(float pansep)
	{
		FmodJNI.FSOUND_SetPanSeperation(pansep);
	}
	 ...
	 * @see Fmod#FMUSIC_LoadSong(String)
	 ...
	 */
	public static void FSOUND_File_SetCallbacks(FSOUND_OPENCALLBACK useropen,
			FSOUND_CLOSECALLBACK userclose, FSOUND_READCALLBACK userread,
			FSOUND_SEEKCALLBACK userseek, FSOUND_TELLCALLBACK usertell)
	{
		FmodJNI.FSOUND_File_SetCallbacks(useropen, userclose, userread, userseek, usertell);
	}
	 ...
	 * @see FMOD_ERRORS
	 * @see Fmod#FSOUND_GetAmplitude(int)
	 * @see Fmod#FSOUND_GetFrequency(int)
	 * @see Fmod#FSOUND_GetPan(int)
	 * @see Fmod#FSOUND_GetPriority(int)
	 * @see Fmod#FSOUND_GetVolume(int)
	 */
	public static int FSOUND_GetError()
	{
		return FmodJNI.FSOUND_GetError();
	}
	...
	{
		return FmodJNI.FSOUND_GetVersion();
	}
	 ...
	 * @see Fmod#FSOUND_GetOutputHandle()
	 * @see FSOUND_OUTPUTTYPES
	 * @see Fmod#FSOUND_SetFrequency(int, int)
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static int FSOUND_GetOutput()
	{
		return FmodJNI.FSOUND_GetOutput();
	}
	 ...
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static Pointer FSOUND_GetOutputHandle()
	{
		long cPtr = FmodJNI.FSOUND_GetOutputHandle();
	...
	{
		return FmodJNI.FSOUND_GetDriver();
	}
	 ...
	 * @see Fmod#FSOUND_DSP_Create(FSOUND_DSPCALLBACK, int, Pointer)
	 * @see Fmod#FSOUND_DSP_MixBuffers(ByteBuffer, ByteBuffer, int, int, int, int, int)
	 * @see Fmod#FSOUND_GetMixer()
	 * @see FSOUND_MIXERTYPES
	 * @see Fmod#FSOUND_SetMixer(int)
	 */
	...
	{
		return FmodJNI.FSOUND_GetMixer();
	}
	...
	{
		return FmodJNI.FSOUND_GetNumDrivers();
	}
	 ...
	 * @see Fmod#FSOUND_SetDriver(int)
	 */
	public static String FSOUND_GetDriverName(int id)
	{
		return FmodJNI.FSOUND_GetDriverName(id);
	}
	 ...
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static boolean FSOUND_GetDriverCaps(int id, int[] caps)
	{
		return FmodJNI.FSOUND_GetDriverCaps(id, caps);
	}
	/**
	 * Returns information on capabilities of the current output mode.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_SetOutput(int)
	 */
	public static boolean FSOUND_GetDriverCaps(int id, IntBuffer caps)
	{
		if(caps != null && !caps.isDirect()) {
			throw new NonDirectBufferException();
		}
		return FmodJNI.FSOUND_GetDriverCaps(id, caps, BufferUtils.getPositionInBytes(caps));
	}
	...
	{
		return FmodJNI.FSOUND_GetOutputRate();
	}
	...
	{
		return FmodJNI.FSOUND_GetMaxChannels();
	}
	...
	{
		return FmodJNI.FSOUND_GetMaxSamples();
	}
	 ...
	 * Supported on the following platforms : Win32, WinCE, Linux, Macintosh, XBox, PlayStation 2, GameCube
	 */
	public static int FSOUND_GetSpeakerMode()
	{
		return FmodJNI.FSOUND_GetSpeakerMode();
	}
	...
	{
		return FmodJNI.FSOUND_GetSFXMasterVolume();
	}
	 ...
	 * On failure, FALSE is returned.
	 */
	public static boolean FSOUND_GetNumHWChannels(int[] num2d, int[] num3d, int[] total)
	{
		return FmodJNI.FSOUND_GetNumHWChannels(num2d, num3d, total);
	}
	/**
	 * Returns the number of available hardware mixed 2d and 3d channels.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * On failure, FALSE is returned.
	 */
	public static boolean FSOUND_GetNumHWChannels(IntBuffer num2d, IntBuffer num3d, IntBuffer total)
	{
		...
		return FmodJNI.FSOUND_GetNumHWChannels(num2d, BufferUtils.getPositionInBytes(num2d),
	 ...
	 * @see Fmod#FMUSIC_OptimizeChannels(FMUSIC_MODULE, int, int)
	 */
	public static int FSOUND_GetChannelsPlaying()
	{
		return FmodJNI.FSOUND_GetChannelsPlaying();
	}
	...
	{
		return FmodJNI.FSOUND_GetCPUUsage();
	}
	 ...
	 * @see Fmod#FSOUND_SetMemorySystem(ByteBuffer, int, FSOUND_ALLOCCALLBACK, FSOUND_REALLOCCALLBACK, FSOUND_FREECALLBACK)
	 */
	public static void FSOUND_GetMemoryStats(int[] currentalloced, int[] maxalloced)
	{
		FmodJNI.FSOUND_GetMemoryStats(currentalloced, maxalloced);
	}
	/**
	 * Returns information on the memory usage of fmod.<br>
	 * This is useful for determining a fixed memory size to make FMOD work within for fixed memory machines such as pocketpc and consoles.<br>
	 ...
	 * @see Fmod#FSOUND_SetMemorySystem(ByteBuffer, int, FSOUND_ALLOCCALLBACK, FSOUND_REALLOCCALLBACK, FSOUND_FREECALLBACK)
	 */
	public static void FSOUND_GetMemoryStats(IntBuffer currentalloced, IntBuffer maxalloced)
	{
		...
		FmodJNI.FSOUND_GetMemoryStats(currentalloced, BufferUtils.getPositionInBytes(currentalloced),
	 ...
	 * @see FSOUND_MODES
	 * @see Fmod#FSOUND_Sample_Alloc(int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_Free(FSOUND_SAMPLE)
	 */
	public static FSOUND_SAMPLE FSOUND_Sample_Load(int index, String name_or_data, int mode,
			int offset, int length)
	{
		long cPtr = FmodJNI.FSOUND_Sample_Load(index, name_or_data, mode, offset, length);
	 ...
	 * @see Fmod#FSOUND_Sample_Free(FSOUND_SAMPLE)
	 */
	public static FSOUND_SAMPLE FSOUND_Sample_Load(int index, ByteBuffer name_or_data, int mode,
			int offset, int length)
	{
		if(name_or_data != null && !name_or_data.isDirect()) {
			throw new NonDirectBufferException();
		}
		long cPtr = FmodJNI.FSOUND_Sample_Load(index, name_or_data, BufferUtils.getPositionInBytes(name_or_data), mode, offset, length);
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_Sample_Free(FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_Sample_Load(int, String, int, int, int)
	 * @see Fmod#FSOUND_Sample_Lock(FSOUND_SAMPLE, int, int, Pointer, Pointer, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_SetDefaults(FSOUND_SAMPLE, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetLoopPoints(FSOUND_SAMPLE, int, int)
	 * @see Fmod#FSOUND_Sample_Unlock(FSOUND_SAMPLE, ByteBuffer, ByteBuffer, int, int)
	 * @see Fmod#FSOUND_Sample_Upload(FSOUND_SAMPLE, ByteBuffer, int)
	 */
	public static FSOUND_SAMPLE FSOUND_Sample_Alloc(int index, int length, int mode, int deffreq,
			int defvol, int defpan, int defpri)
	{
		long cPtr = FmodJNI.FSOUND_Sample_Alloc(index, length, mode, deffreq, defvol, defpan, defpri);
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_Sample_Load(int, String, int, int, int)
	 */
	public static void FSOUND_Sample_Free(FSOUND_SAMPLE sptr)
	{
		FmodJNI.FSOUND_Sample_Free(Pointer.getPointer(sptr));
	}
	 ...
	 * @see Fmod#FSOUND_Sample_Unlock(FSOUND_SAMPLE, ByteBuffer, ByteBuffer, int, int)
	 */
	public static boolean FSOUND_Sample_Upload(FSOUND_SAMPLE sptr, ByteBuffer srcdata, int mode)
	{
		if(srcdata != null && !srcdata.isDirect()) {
			throw new NonDirectBufferException();
		}
		return FmodJNI.FSOUND_Sample_Upload(Pointer.getPointer(sptr),
												  srcdata, BufferUtils.getPositionInBytes(srcdata),
												  mode);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_Upload(FSOUND_SAMPLE, ByteBuffer, int)
	 */
	public static boolean FSOUND_Sample_Lock(FSOUND_SAMPLE sptr, int offset, int length,
			Pointer ptr1, Pointer ptr2, int[] len1, int[] len2)
	{
		boolean result = FmodJNI.FSOUND_Sample_Lock(Pointer.getPointer(sptr), offset, length,
				ptr1, ptr2, len1, len2);
		return result;
	}
	/**
	 ...
	 */
	public static boolean FSOUND_Sample_Lock(FSOUND_SAMPLE sptr, int offset, int length,
			Pointer ptr1, Pointer ptr2, IntBuffer len1, IntBuffer len2)
	{
	 ...
	 * @see Fmod#FSOUND_Sample_Upload(FSOUND_SAMPLE, ByteBuffer, int)
	 */
	public static boolean FSOUND_Sample_Unlock(FSOUND_SAMPLE sptr, Pointer ptr1, Pointer ptr2,
			int len1, int len2)
	{
		return FmodJNI.FSOUND_Sample_Unlock(Pointer.getPointer(sptr),
				Pointer.getPointer(ptr1), Pointer.getPointer(ptr2), len1, len2);
	}
	/**
	 * Releases previous sample data lock from FSOUND_Sample_Lock<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Sample_Upload(FSOUND_SAMPLE, ByteBuffer, int)
	 */
	public static boolean FSOUND_Sample_Unlock(FSOUND_SAMPLE sptr, ByteBuffer ptr1, ByteBuffer ptr2,
			int len1, int len2)
	{
		...
		return FmodJNI.FSOUND_Sample_Unlock(Pointer.getPointer(sptr),
				ptr1, BufferUtils.getPositionInBytes(ptr1), ptr2, BufferUtils.getPositionInBytes(ptr2), len1, len2);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetLoopMode(int)
	 * @see FSOUND_MODES
	 * @see Fmod#FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_GetMode(FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_Sample_SetDefaults(FSOUND_SAMPLE, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetLoopPoints(FSOUND_SAMPLE, int, int)
	 */
	public static boolean FSOUND_Sample_SetMode(FSOUND_SAMPLE sptr, int mode)
	{
		return FmodJNI.FSOUND_Sample_SetMode(Pointer.getPointer(sptr), mode);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_Alloc(int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_SetMode(FSOUND_SAMPLE, int)
	 */
	public static boolean FSOUND_Sample_SetLoopPoints(FSOUND_SAMPLE sptr, int loopstart, int loopend)
	{
		return FmodJNI.FSOUND_Sample_SetLoopPoints(Pointer.getPointer(sptr), loopstart,
				loopend);
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Sample_Alloc(int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_GetDefaults(FSOUND_SAMPLE, IntBuffer, IntBuffer, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_GetDefaultsEx(FSOUND_SAMPLE, IntBuffer, IntBuffer, IntBuffer, IntBuffer, IntBuffer, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_Sample_GetMode(FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetMode(FSOUND_SAMPLE, int)
	 * @see Fmod#FSOUND_SetFrequency(int, int)
	 * @see Fmod#FSOUND_SetPan(int, int)
	 * @see Fmod#FSOUND_SetPriority(int, int)
	 * @see Fmod#FSOUND_SetVolume(int, int)
	 */
	public static boolean FSOUND_Sample_SetDefaults(FSOUND_SAMPLE sptr, int deffreq, int defvol,
			int defpan, int defpri)
	{
		return FmodJNI.FSOUND_Sample_SetDefaults(Pointer.getPointer(sptr), deffreq,
				defvol, defpan, defpri);
	}
	 ...
	 * @see Fmod#FSOUND_SetVolume(int, int)
	 */
	public static boolean FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE sptr, int deffreq, int defvol,
			int defpan, int defpri, int varfreq, int varvol, int varpan)
	{
		return FmodJNI.FSOUND_Sample_SetDefaultsEx(Pointer.getPointer(sptr), deffreq,
				defvol, defpan, defpri, varfreq, varvol, varpan);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_3D_GetAttributes(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_GetMinMaxDistance(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_SetAttributes(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_SetDistanceFactor(float)
	 * @see Fmod#FSOUND_3D_SetMinMaxDistance(int, float, float)
	 * @see Fmod#FSOUND_Sample_GetMinMaxDistance(FSOUND_SAMPLE, FloatBuffer, FloatBuffer)
	 */
	public static boolean FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE sptr, float min, float max)
	{
		return FmodJNI.FSOUND_Sample_SetMinMaxDistance(Pointer.getPointer(sptr), min, max);
	}
	 ...
	 * @see Fmod#FSOUND_PlaySound(int, FSOUND_SAMPLE)
	 */
	public static boolean FSOUND_Sample_SetMaxPlaybacks(FSOUND_SAMPLE sptr, int max)
	{
		return FmodJNI.FSOUND_Sample_SetMaxPlaybacks(Pointer.getPointer(sptr), max);
	}
	 ...
	 * @see Fmod#FSOUND_Close()
	 */
	public static FSOUND_SAMPLE FSOUND_Sample_Get(int sampno)
	{
		long cPtr = FmodJNI.FSOUND_Sample_Get(sampno);
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * On failure, NULL is returned.
	 */
	public static String FSOUND_Sample_GetName(FSOUND_SAMPLE sptr)
	{
		return FmodJNI.FSOUND_Sample_GetName(Pointer.getPointer(sptr));
	}
	 ...
	 */
	public static int FSOUND_Sample_GetLength(FSOUND_SAMPLE sptr)
	{
		return FmodJNI.FSOUND_Sample_GetLength(Pointer.getPointer(sptr));
	}
	 ...
	 * @see Fmod#FSOUND_Sample_SetMode(FSOUND_SAMPLE, int)
	 */
	public static boolean FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE sptr, int[] loopstart, int[] loopend)
	{
		return FmodJNI.FSOUND_Sample_GetLoopPoints(Pointer.getPointer(sptr),
				loopstart, loopend);
	}
	/**
	 * Returns the start and end positions of the specified sample loop in SAMPLES (not bytes)<br>
	 ...
	 * @see Fmod#FSOUND_Sample_SetMode(FSOUND_SAMPLE, int)
	 */
	public static boolean FSOUND_Sample_GetLoopPoints(FSOUND_SAMPLE sptr, IntBuffer loopstart, IntBuffer loopend)
	{
	 ...
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 */
	public static boolean FSOUND_Sample_GetDefaults(FSOUND_SAMPLE sptr,
			int[] deffreq, int[] defvol, int[] defpan, int[] defpri)
	{
		return FmodJNI.FSOUND_Sample_GetDefaults(Pointer.getPointer(sptr),
			deffreq, defvol, defpan, defpri);
	}
	/**
	 * Returns the default volume, frequency, pan and priority values for the specified sample.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 */
	public static boolean FSOUND_Sample_GetDefaults(FSOUND_SAMPLE sptr,
			IntBuffer deffreq, IntBuffer defvol, IntBuffer defpan, IntBuffer defpri)
	{
	 ...
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 */
	public static boolean FSOUND_Sample_GetDefaultsEx(FSOUND_SAMPLE sptr,
			int[] deffreq, int[] defvol, int[] defpan, int[] defpri, int[] varfreq, int[] varvol, int[] varpan)
	{
		return FmodJNI.FSOUND_Sample_GetDefaultsEx(Pointer.getPointer(sptr),
				deffreq, defvol, defpan, defpri,
				varfreq, varvol, varpan);
	}
	/**
	 * Returns the default volume, frequency, pan, priority and random playback variations for the specified sample.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 */
	public static boolean FSOUND_Sample_GetDefaultsEx(FSOUND_SAMPLE sptr,
			IntBuffer deffreq, IntBuffer defvol, IntBuffer defpan, IntBuffer defpri, IntBuffer varfreq,
			IntBuffer varvol, IntBuffer varpan)
	{
		if(deffreq != null && !deffreq.isDirect()) {
			throw new NonDirectBufferException();
		}
	 ...
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetMode(FSOUND_SAMPLE, int)
	 * @see Fmod#FSOUND_SetLoopMode(int, int)
	 */
	public static int FSOUND_Sample_GetMode(FSOUND_SAMPLE sptr)
	{
		return FmodJNI.FSOUND_Sample_GetMode(Pointer.getPointer(sptr));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_3D_SetDistanceFactor(float)
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_Sample_GetMinMaxDistance(FSOUND_SAMPLE sptr, float[] min,
			float[] max)
	{
		return FmodJNI.FSOUND_Sample_GetMinMaxDistance(Pointer.getPointer(sptr),
				min, max);
	}
	/**
	 * Get the minimum and maximum audible distance for a sample.
	 ...
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_Sample_GetMinMaxDistance(FSOUND_SAMPLE sptr, FloatBuffer min,
			FloatBuffer max)
	{
	 ...
	 * @see Fmod#FSOUND_FX_Enable(int, int)
	 * @see Fmod#FSOUND_GetNumHWChannels(IntBuffer, IntBuffer, IntBuffer)
	 * @see Fmod#FSOUND_GetNumSubChannels(int)
	 * @see Fmod#FSOUND_GetSubChannel(int, int)
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_PlaySoundEx(int, FSOUND_SAMPLE, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_Sample_SetMaxPlaybacks(FSOUND_SAMPLE, int)
	 * @see Fmod#FSOUND_StopSound(int)
	 */
	public static int FSOUND_PlaySound(int channel, FSOUND_SAMPLE sptr)
	{
		return FmodJNI.FSOUND_PlaySound(channel, Pointer.getPointer(sptr));
	}
	 ...
	 * @see Fmod#FSOUND_Init(int, int, int)
	 * @see Fmod#FSOUND_PlaySound(int, FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_SetPaused(int, boolean)
	 * @see Fmod#FSOUND_StopSound(int)
	 */
	public static int FSOUND_PlaySoundEx(int channel, FSOUND_SAMPLE sptr, FSOUND_DSPUNIT dsp,
			boolean startpaused)
	{
		return FmodJNI.FSOUND_PlaySoundEx(channel, Pointer.getPointer(sptr),
				Pointer.getPointer(dsp), startpaused);
	}
	...
	{
		return FmodJNI.FSOUND_StopSound(channel);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_SetDefaults(FSOUND_SAMPLE, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_SetCurrentPosition(int, int)
	 */
	public static boolean FSOUND_SetFrequency(int channel, int freq)
	{
		return FmodJNI.FSOUND_SetFrequency(channel, freq);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_SetDefaults(FSOUND_SAMPLE, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_SetSFXMasterVolume(int)
	 * @see Fmod#FSOUND_SetVolumeAbsolute(int, int)
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 */
	public static boolean FSOUND_SetVolume(int channel, int vol)
	{
		return FmodJNI.FSOUND_SetVolume(channel, vol);
	}
	 ...
	 * @see Fmod#FSOUND_SetVolumeAbsolute(int, int)
	 */
	public static boolean FSOUND_SetVolumeAbsolute(int channel, int vol)
	{
		return FmodJNI.FSOUND_SetVolumeAbsolute(channel, vol);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 */
	public static boolean FSOUND_SetPan(int channel, int pan)
	{
		return FmodJNI.FSOUND_SetPan(channel, pan);
	}
	 ...
	 * @return On success, TRUE is returned.
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetSurround(int)
	 */
	public static boolean FSOUND_SetSurround(int channel, boolean surround)
	{
		return FmodJNI.FSOUND_SetSurround(channel, surround);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetMute(int)
	 */
	public static boolean FSOUND_SetMute(int channel, boolean mute)
	{
		return FmodJNI.FSOUND_SetMute(channel, mute);
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetPriority(int)
	 * @see Fmod#FSOUND_GetReserved(int)
	 * @see Fmod#FSOUND_Sample_SetDefaults(FSOUND_SAMPLE, int, int, int, int)
	 * @see Fmod#FSOUND_Sample_SetDefaultsEx(FSOUND_SAMPLE, int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_SetReserved(int, boolean)
	 */
	public static boolean FSOUND_SetPriority(int channel, int priority)
	{
		return FmodJNI.FSOUND_SetPriority(channel, priority);
	}
	 ...
	 * @see Fmod#FSOUND_SetPriority(int, int)
	 */
	public static boolean FSOUND_SetReserved(int channel, boolean reserved)
	{
		return FmodJNI.FSOUND_SetReserved(channel, reserved);
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_FX_Enable(int, int)
	 * @see Fmod#FSOUND_GetPaused(int)
	 * @see Fmod#FSOUND_PlaySoundEx(int, FSOUND_SAMPLE, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 */
	public static boolean FSOUND_SetPaused(int channel, boolean paused)
	{
		return FmodJNI.FSOUND_SetPaused(channel, paused);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_GetMode(FSOUND_SAMPLE)
	 */
	public static boolean FSOUND_SetLoopMode(int channel, int loopmode)
	{
		return FmodJNI.FSOUND_SetLoopMode(channel, loopmode);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetCurrentPosition(int)
	 * @see Fmod#FSOUND_SetFrequency(int, int)
	 */
	public static boolean FSOUND_SetCurrentPosition(int channel, int offset)
	{
		return FmodJNI.FSOUND_SetCurrentPosition(channel, offset);
	}
	 ...
	 * @see Fmod#FSOUND_3D_GetAttributes(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_GetMinMaxDistance(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_Listener_GetAttributes(FloatBuffer, FloatBuffer, FloatBuffer, FloatBuffer, FloatBuffer, FloatBuffer, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_Listener_SetAttributes(FloatBuffer, FloatBuffer, float, float, float, float, float, float)
	 * @see Fmod#FSOUND_3D_Listener_SetCurrent(int, int)
	 * @see Fmod#FSOUND_3D_SetAttributes(int, FloatBuffer, FloatBuffer)
	 * @see Fmod#FSOUND_3D_SetDistanceFactor(float)
	 * @see Fmod#FSOUND_3D_SetMinMaxDistance(int, float, float)
	 * @see Fmod#FSOUND_3D_SetRolloffFactor(float)
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 * @see Fmod#FSOUND_Update()
	 */
	public static boolean FSOUND_3D_SetAttributes(int channel, float[] pos, float[] vel)
	{
		return FmodJNI.FSOUND_3D_SetAttributes(channel, pos, vel);
	}
	/**
	 * This updates the position and velocity of a 3d sound playing on a channel.<br>
	 * <br><b>Remarks :</b><br>
	...
	public static boolean FSOUND_3D_SetAttributes(int channel, FloatBuffer pos, FloatBuffer vel)
	{
		...
		return FmodJNI.FSOUND_3D_SetAttributes(channel, pos, BufferUtils.getPositionInBytes(pos),
	 ...
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_3D_SetMinMaxDistance(int channel, float min, float max)
	{
		return FmodJNI.FSOUND_3D_SetMinMaxDistance(channel, min, max);
	}
	...
	{
		return FmodJNI.FSOUND_IsPlaying(channel);
	}
	 ...
	 * @see Fmod#FSOUND_GetError()
	 * @see Fmod#FSOUND_SetFrequency(int, int)
	 */
	public static int FSOUND_GetFrequency(int channel)
	{
		return FmodJNI.FSOUND_GetFrequency(channel);
	}
	...
	{
		return FmodJNI.FSOUND_GetVolume(channel);
	}
	...
	{
		return FmodJNI.FSOUND_GetAmplitude(channel);
	}
	 ...
	 * On failure, 0 is returned. To quailfy if this is a real error, call FSOUND_GetError.
	 * @see Fmod#FSOUND_GetError()
	 * @see Fmod#FSOUND_SetLevels(int, int, int, int, int, int, int)
	 * @see Fmod#FSOUND_SetPan(int, int)
	 */
	public static int FSOUND_GetPan(int channel)
	{
		return FmodJNI.FSOUND_GetPan(channel);
	}
	 ...
	 * @see Fmod#FSOUND_SetSurround(int, boolean)
	 */
	public static boolean FSOUND_GetSurround(int channel)
	{
		return FmodJNI.FSOUND_GetSurround(channel);
	}
	 ...
	 * @see Fmod#FSOUND_SetMute(int, boolean)
	 */
	public static boolean FSOUND_GetMute(int channel)
	{
		return FmodJNI.FSOUND_GetMute(channel);
	}
	...
	{
		return FmodJNI.FSOUND_GetPriority(channel);
	}
	 ...
	 * @see Fmod#FSOUND_SetReserved(int, boolean)
	 */
	public static boolean FSOUND_GetReserved(int channel)
	{
		return FmodJNI.FSOUND_GetReserved(channel);
	}
	...
	{
		return FmodJNI.FSOUND_GetPaused(channel);
	}
	...
	{
		return FmodJNI.FSOUND_GetLoopMode(channel);
	}
	 ...
	 * On failure, 0 is returned.
	 * @see Fmod#FSOUND_Record_StartSample(FSOUND_SAMPLE, boolean)
	 * @see Fmod#FSOUND_SetCurrentPosition(int, int)
	 */
	public static int FSOUND_GetCurrentPosition(int channel)
	{
		return FmodJNI.FSOUND_GetCurrentPosition(channel);
	}
	 ...
	 * On failure, NULL is returned.
	 */
	public static FSOUND_SAMPLE FSOUND_GetCurrentSample(int channel)
	{
		long cPtr = FmodJNI.FSOUND_GetCurrentSample(channel);
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_Init(int, int, int)
	 */
	public static boolean FSOUND_GetCurrentLevels(int channel, float[] l, float[] r)
	{
		return FmodJNI.FSOUND_GetCurrentLevels(channel, l, r);
	}
	/**
	 * Returns a left and right VU/Level reading at the current position of the specified channel.<br>
	 * Levels are are only supported for software channels.<br>
	 ...
	 * @see Fmod#FSOUND_Init(int, int, int)
	 */
	public static boolean FSOUND_GetCurrentLevels(int channel, FloatBuffer l, FloatBuffer r)
	{
		...
		return FmodJNI.FSOUND_GetCurrentLevels(channel, l, BufferUtils.getPositionInBytes(l),
	...
	{
		return FmodJNI.FSOUND_GetNumSubChannels(channel);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 */
	public static int FSOUND_GetSubChannel(int channel, int subchannel)
	{
		return FmodJNI.FSOUND_GetSubChannel(channel, subchannel);
	}
	 ...
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_3D_GetAttributes(int channel, float[] pos, float[] vel)
	{
		return FmodJNI.FSOUND_3D_GetAttributes(channel, pos, vel);
	}
	/**
	 * <br><b>Remarks :</b><br>
	 * A 'distance unit' is specified by FSOUND_3D_SetDistanceFactor. By default this is set to meters which is a distance scale of 1.0. <br>
	...
	public static boolean FSOUND_3D_GetAttributes(int channel, FloatBuffer pos, FloatBuffer vel)
	{
		...
		return FmodJNI.FSOUND_3D_GetAttributes(channel, pos, BufferUtils.getPositionInBytes(pos),
				vel, BufferUtils.getPositionInBytes(vel));
	}
	 ...
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_3D_GetMinMaxDistance(int channel, float[] min, float[] max)
	{
		return FmodJNI.FSOUND_3D_GetMinMaxDistance(channel, min, max);
	}
	/**
	 * Returns the current min and max distance for a channel.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Sample_SetMinMaxDistance(FSOUND_SAMPLE, float, float)
	 */
	public static boolean FSOUND_3D_GetMinMaxDistance(int channel, FloatBuffer min, FloatBuffer max)
	{
		if(min != null && !min.isDirect()) {
			throw new NonDirectBufferException();
		}
		...
		return FmodJNI.FSOUND_3D_GetMinMaxDistance(channel, min, BufferUtils.getPositionInBytes(min),
				max, BufferUtils.getPositionInBytes(max));
	}
	 ...
	 * @see Fmod#FSOUND_Update()
	 */
	public static void FSOUND_3D_Listener_SetAttributes(float[] pos, float[] vel,
			float fx, float fy, float fz, float tx, float ty, float tz)
	{
		FmodJNI.FSOUND_3D_Listener_SetAttributes(pos, vel,
				fx, fy, fz, tx, ty, tz);
	}
	/**
	 * This updates the position, velocity and orientation of a 3d sound listener.<br>
	 ...
	 * @see Fmod#FSOUND_Update()
	 */
	public static void FSOUND_3D_Listener_SetAttributes(FloatBuffer pos, FloatBuffer vel,
			float fx, float fy, float fz, float tx, float ty, float tz)
	{
		if(pos != null && !pos.isDirect()) {
			throw new NonDirectBufferException();
		...
		FmodJNI.FSOUND_3D_Listener_SetAttributes(pos, BufferUtils.getPositionInBytes(pos), vel, BufferUtils.getPositionInBytes(vel),
				fx, fy, fz, tx, ty, tz);
	}
	 ...
	 * @see Fmod#FSOUND_3D_SetDopplerFactor(float)
	 */
	public static void FSOUND_3D_Listener_GetAttributes(float[] pos, float[] vel,
		float[] fx, float[] fy, float[] fz,
		float[] tx, float[] ty, float[] tz)
	{
		FmodJNI.FSOUND_3D_Listener_GetAttributes(pos, vel,
			fx, fy, fz,
			tx, ty, tz);
	}
	/**
	 ...
	 * @see Fmod#FSOUND_3D_SetDopplerFactor(float)
	 */
	public static void FSOUND_3D_Listener_GetAttributes(FloatBuffer pos, FloatBuffer vel,
		FloatBuffer fx, FloatBuffer fy, FloatBuffer fz,
		FloatBuffer tx, FloatBuffer ty, FloatBuffer tz)
	{
		...
		FmodJNI.FSOUND_3D_Listener_GetAttributes(pos, BufferUtils.getPositionInBytes(pos),
				vel, BufferUtils.getPositionInBytes(vel),
	 ...
	 * @see Fmod#FSOUND_Update()
	 */
	public static void FSOUND_3D_Listener_SetCurrent(int current, int numlisteners)
	{
		FmodJNI.FSOUND_3D_Listener_SetCurrent(current, numlisteners);
	}
	...
	{
		FmodJNI.FSOUND_3D_SetDopplerFactor(scale);
	}
	...
	{
		FmodJNI.FSOUND_3D_SetDistanceFactor(scale);
	}
	 ...
	 * @see Fmod#FSOUND_3D_SetDistanceFactor(float)
	 */
	public static void FSOUND_3D_SetRolloffFactor(float scale)
	{
		FmodJNI.FSOUND_3D_SetRolloffFactor(scale);
	}
	 ...
	 * On failure, -1 is returned.
	 * @see Fmod#FSOUND_FX_Disable(int)
	 * @see FSOUND_FX_MODES
	 * @see Fmod#FSOUND_FX_SetChorus(int, float, float, float, float, int, float, int)
	 * @see Fmod#FSOUND_FX_SetCompressor(int, float, float, float, float, float, float)
	 * @see Fmod#FSOUND_FX_SetDistortion(int, float, float, float, float, float)
	 * @see Fmod#FSOUND_FX_SetEcho(int, float, float, float, float, boolean)
	 * @see Fmod#FSOUND_FX_SetFlanger(int, float, float, float, float, int, float, int)
	 * @see Fmod#FSOUND_FX_SetGargle(int, int, int)
	 * @see Fmod#FSOUND_FX_SetI3DL2Reverb(int, int, int, float, float, float, int, float, int, float, float, float, float)
	 * @see Fmod#FSOUND_FX_SetParamEQ(int, float, float, float)
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 * @see Fmod#FSOUND_PlaySound(int, FSOUND_SAMPLE)
	 * @see Fmod#FSOUND_PlaySoundEx(int, FSOUND_SAMPLE, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_SetPaused(int, boolean)
	 */
	public static int FSOUND_FX_Enable(int channel, int fxtype)
	{
		return FmodJNI.FSOUND_FX_Enable(channel, fxtype);
	}
	...
	{
		return FmodJNI.FSOUND_FX_Disable(channel);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetChorus(int fxid, float WetDryMix, float Depth, float Feedback,
			float Frequency, int Waveform, float Delay, int Phase)
	{
		return FmodJNI.FSOUND_FX_SetChorus(fxid, WetDryMix, Depth, Feedback, Frequency,
				Waveform, Delay, Phase);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetCompressor(int fxid, float Gain, float Attack, float Release,
			float Threshold, float Ratio, float Predelay)
	{
		return FmodJNI.FSOUND_FX_SetCompressor(fxid, Gain, Attack, Release, Threshold, Ratio,
				Predelay);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetDistortion(int fxid, float Gain, float Edge,
			float PostEQCenterFrequency, float PostEQBandwidth, float PreLowpassCutoff)
	{
		return FmodJNI.FSOUND_FX_SetDistortion(fxid, Gain, Edge, PostEQCenterFrequency,
				PostEQBandwidth, PreLowpassCutoff);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetEcho(int fxid, float WetDryMix, float Feedback,
			float LeftDelay, float RightDelay, boolean PanDelay)
	{
		return FmodJNI.FSOUND_FX_SetEcho(fxid, WetDryMix, Feedback, LeftDelay, RightDelay, PanDelay);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetFlanger(int fxid, float WetDryMix, float Depth, float Feedback,
			float Frequency, int Waveform, float Delay, int Phase)
	{
		return FmodJNI.FSOUND_FX_SetFlanger(fxid, WetDryMix, Depth, Feedback, Frequency,
				Waveform, Delay, Phase);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetGargle(int fxid, int RateHz, int WaveShape)
	{
		return FmodJNI.FSOUND_FX_SetGargle(fxid, RateHz, WaveShape);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetI3DL2Reverb(int fxid, int Room, int RoomHF,
			float RoomRolloffFactor, float DecayTime, float DecayHFRatio, int Reflections,
			float ReflectionsDelay, int Reverb, float ReverbDelay, float Diffusion, float Density,
			float HFReference)
	{
		return FmodJNI.FSOUND_FX_SetI3DL2Reverb(fxid, Room, RoomHF, RoomRolloffFactor,
				DecayTime, DecayHFRatio, Reflections, ReflectionsDelay, Reverb, ReverbDelay,
				Diffusion, Density, HFReference);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetWavesReverb(int, float, float, float, float)
	 */
	public static boolean FSOUND_FX_SetParamEQ(int fxid, float Center, float Bandwidth, float Gain)
	{
		return FmodJNI.FSOUND_FX_SetParamEQ(fxid, Center, Bandwidth, Gain);
	}
	 ...
	 * @see Fmod#FSOUND_FX_SetParamEQ(int, float, float, float)
	 */
	public static boolean FSOUND_FX_SetWavesReverb(int fxid, float InGain, float ReverbMix,
			float ReverbTime, float HighFreqRTRatio)
	{
		return FmodJNI.FSOUND_FX_SetWavesReverb(fxid, InGain, ReverbMix, ReverbTime,
				HighFreqRTRatio);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Stream_Create(FSOUND_STREAMCALLBACK, int, int, int, Pointer)
	 * @see Fmod#FSOUND_Stream_Open(String, int, int, int)
	 */
	public static boolean FSOUND_Stream_SetBufferSize(int ms)
	{
		return FmodJNI.FSOUND_Stream_SetBufferSize(ms);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_GetLength(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetLengthMs(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetOpenState(FSOUND_STREAM)
	 ...
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_Stream_SetBufferSize(int)
	 * @see Fmod#FSOUND_Stream_SetSubStream(FSOUND_STREAM, int)
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static FSOUND_STREAM FSOUND_Stream_Open(String name, int mode, int offset, int length)
	{
		long cPtr = FmodJNI.FSOUND_Stream_Open(name, mode, offset, length);
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static FSOUND_STREAM FSOUND_Stream_Open(ByteBuffer data, int mode, int offset, int length)
	{
		if(data != null && !data.isDirect()) {
			throw new NonDirectBufferException();
		}
		long cPtr = FmodJNI.FSOUND_Stream_Open(data, BufferUtils.getPositionInBytes(data), mode, offset, length);
		return (cPtr == 0) ? null : FSOUND_STREAM.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 */
	//TODO userdata
	public static FSOUND_STREAM FSOUND_Stream_Create(FSOUND_STREAMCALLBACK callback, int length,
			int mode, int samplerate, Pointer userdata)
	{
		long cPtr = FmodJNI.FSOUND_Stream_Create(callback, length,
				mode, samplerate, Pointer.getPointer(userdata));
		return (cPtr == 0) ? null : FSOUND_STREAM.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Close(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_Close(Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Open(String, int, int, int)
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_Stream_SetEndCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 * @see Fmod#FSOUND_Stream_SetLoopCount(FSOUND_STREAM, int)
	 * @see Fmod#FSOUND_Stream_SetSubStream(FSOUND_STREAM, int)
	 * @see Fmod#FSOUND_Stream_SetSubStreamSentence(FSOUND_STREAM, IntBuffer, int)
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static int FSOUND_Stream_Play(int channel, FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_Play(channel, Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static int FSOUND_Stream_PlayEx(int channel, FSOUND_STREAM stream, FSOUND_DSPUNIT dsp,
			boolean startpaused)
	{
		return FmodJNI.FSOUND_Stream_PlayEx(channel, Pointer.getPointer(stream),
				Pointer.getPointer(dsp), startpaused);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_PlayEx(int, FSOUND_STREAM, FSOUND_DSPUNIT, boolean)
	 */
	public static boolean FSOUND_Stream_Stop(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_Stop(Pointer.getPointer(stream));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Stream_GetLength(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetPosition(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_SetTime(FSOUND_STREAM, int)
	 */
	public static boolean FSOUND_Stream_SetPosition(FSOUND_STREAM stream, int position)
	{
		return FmodJNI.FSOUND_Stream_SetPosition(Pointer.getPointer(stream), position);
	}
	 ...
	 * On failure, 0 is returned.
	 * @see Fmod#FSOUND_Stream_GetLength(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_SetPosition(FSOUND_STREAM, int)
	 * @see Fmod#FSOUND_Stream_SetTime(FSOUND_STREAM, int)
	 */
	public static int FSOUND_Stream_GetPosition(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetPosition(Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_GetLength(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetPosition(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetTime(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_SetPosition(FSOUND_STREAM, int)
	 */
	public static boolean FSOUND_Stream_SetTime(FSOUND_STREAM stream, int ms)
	{
		return FmodJNI.FSOUND_Stream_SetTime(Pointer.getPointer(stream), ms);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetTime(FSOUND_STREAM, int)
	 */
	public static int FSOUND_Stream_GetTime(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetTime(Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetTime(FSOUND_STREAM, int)
	 */
	public static int FSOUND_Stream_GetLength(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetLength(Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Open(String, int, int, int)
	 */
	public static int FSOUND_Stream_GetLengthMs(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetLengthMs(Pointer.getPointer(stream));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see FSOUND_MODES
	 * @see Fmod#FSOUND_Stream_GetMode(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_SetMode(FSOUND_STREAM stream, int mode)
	{
		return FmodJNI.FSOUND_Stream_SetMode(Pointer.getPointer(stream), mode);
	}
	 ...
	 * @see FSOUND_MODES
	 * @see Fmod#FSOUND_Stream_SetMode(FSOUND_STREAM, int)
	 */
	public static int FSOUND_Stream_GetMode(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetMode(Pointer.getPointer(stream));
	}
	 ...
	 * On failure, FALSE is returned.
	 */
	public static boolean FSOUND_Stream_SetLoopPoints(FSOUND_STREAM stream, int loopstartpcm, int loopendpcm)
	{
		return FmodJNI.FSOUND_Stream_SetLoopPoints(Pointer.getPointer(stream), loopstartpcm, loopendpcm);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_SetLoopCount(FSOUND_STREAM stream, int count)
	{
		return FmodJNI.FSOUND_Stream_SetLoopCount(Pointer.getPointer(stream), count);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Open
	 * @see Fmod#FSOUND_Stream_SetSubStream
	 * @see Fmod#FSOUND_Stream_SetSubStreamSentence
	 */
	public static int FSOUND_Stream_GetOpenState(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetOpenState(Pointer.getPointer(stream));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static FSOUND_SAMPLE FSOUND_Stream_GetSample(FSOUND_STREAM stream)
	{
		long cPtr = FmodJNI.FSOUND_Stream_GetSample(Pointer.getPointer(stream));
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 */
	//TODO userdata
	public static FSOUND_DSPUNIT FSOUND_Stream_CreateDSP(FSOUND_STREAM stream,
			FSOUND_DSPCALLBACK callback, int priority, Pointer userdata)
	{
		long cPtr = FmodJNI.FSOUND_Stream_CreateDSP(Pointer.getPointer(stream),
				callback, priority,
	 ...
	 */
	//TODO userdata
	public static boolean FSOUND_Stream_SetEndCallback(FSOUND_STREAM stream,
			FSOUND_STREAMCALLBACK callback, Pointer userdata)
	{
		return FmodJNI.FSOUND_Stream_SetEndCallback(Pointer.getPointer(stream),
				callback,
				Pointer.getPointer(userdata));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see FSOUND_MODES
	 * @see Fmod#FSOUND_Stream_AddSyncPoint(FSOUND_STREAM, int, String)
	 * @see Fmod#FSOUND_Stream_DeleteSyncPoint(FSOUND_SYNCPOINT)
	 * @see Fmod#FSOUND_Stream_GetNumSyncPoints(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetSyncPoint(FSOUND_STREAM, int)
	 * @see Fmod#FSOUND_Stream_GetSyncPointInfo(FSOUND_SYNCPOINT, IntBuffer)
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 * @see FSOUND_STREAMCALLBACK
	 */
	//TODO userdata
	public static boolean FSOUND_Stream_SetSyncCallback(FSOUND_STREAM stream,
			FSOUND_STREAMCALLBACK callback, Pointer userdata)
	{
		return FmodJNI.FSOUND_Stream_SetSyncCallback(Pointer.getPointer(stream),
				callback,
				Pointer.getPointer(userdata));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static FSOUND_SYNCPOINT FSOUND_Stream_AddSyncPoint(FSOUND_STREAM stream, int pcmoffset, String name)
	{
		long cPtr = FmodJNI.FSOUND_Stream_AddSyncPoint(Pointer.getPointer(stream), pcmoffset, name);
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static boolean FSOUND_Stream_DeleteSyncPoint(FSOUND_SYNCPOINT point)
	{
		return FmodJNI.FSOUND_Stream_DeleteSyncPoint(Pointer.getPointer(point));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static int FSOUND_Stream_GetNumSyncPoints(FSOUND_STREAM stream)
	{
		return FmodJNI.FSOUND_Stream_GetNumSyncPoints(Pointer.getPointer(stream));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static FSOUND_SYNCPOINT FSOUND_Stream_GetSyncPoint(FSOUND_STREAM stream, int index)
	{
		long cPtr = FmodJNI.FSOUND_Stream_GetSyncPoint(Pointer.getPointer(stream), index);
		return (cPtr == 0) ? null : FSOUND_SYNCPOINT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static String FSOUND_Stream_GetSyncPointInfo(FSOUND_SYNCPOINT point, int[] pcmoffset)
	{
		return FmodJNI.FSOUND_Stream_GetSyncPointInfo(Pointer.getPointer(point), pcmoffset);
	}
	/**
	 * Retrieves the name and pcm offset in samples for a specified sync point.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Stream_SetSyncCallback(FSOUND_STREAM, FSOUND_STREAMCALLBACK, Pointer)
	 */
	public static String FSOUND_Stream_GetSyncPointInfo(FSOUND_SYNCPOINT point, IntBuffer pcmoffset)
	{
		if(pcmoffset != null && !pcmoffset.isDirect()) {
			throw new NonDirectBufferException();
		}
		return FmodJNI.FSOUND_Stream_GetSyncPointInfo(Pointer.getPointer(point), pcmoffset, BufferUtils.getPositionInBytes(pcmoffset));
	}
	 ...
	 * @return On success, TRUE is returned.
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Stream_GetNumSubStreams(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_GetOpenState(FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_Open(String, int, int, int)
	 * @see Fmod#FSOUND_Stream_Play(int, FSOUND_STREAM)
	 * @see Fmod#FSOUND_Stream_SetSubStreamSentence(FSOUND_STREAM, IntBuffer, int)
	 */
	public static boolean FSOUND_Stream_SetSubStream(FSOUND_STREAM stream, int index)
	{
		return FmodJNI.FSOUND_Stream_SetSubStream(Pointer.getPointer(stream), index);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_SetSubStream(FSOUND_STREAM, int)
	 */
	public static boolean FSOUND_Stream_SetSubStreamSentence(FSOUND_STREAM stream,
			int[] sentencelist, int numitems)
	{
		return FmodJNI.FSOUND_Stream_SetSubStreamSentence(Pointer.getPointer(stream),
				sentencelist, numitems);
	}
	/**
	 * This function allows the user to describe the playback order of a list of substreams. The substreams will be played back in order seamlessly.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 */
	public static boolean FSOUND_Stream_SetSubStreamSentence(FSOUND_STREAM stream,
			IntBuffer sentencelist, int numitems)
	{
		if(sentencelist != null && !sentencelist.isDirect()) {
			throw new NonDirectBufferException();
		}
		return FmodJNI.FSOUND_Stream_SetSubStreamSentence(Pointer.getPointer(stream),
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Stream_FindTagField(FSOUND_STREAM, int, String, Pointer, IntBuffer)
	 * @see Fmod#FSOUND_Stream_GetTagField(FSOUND_STREAM, int, IntBuffer, Pointer, Pointer, IntBuffer)
	 */
	public static boolean FSOUND_Stream_GetNumTagFields(FSOUND_STREAM stream, int[] num)
	{
		return FmodJNI.FSOUND_Stream_GetNumTagFields(Pointer.getPointer(stream), num);
	}
	/**
	 * Get the number of tag fields associated with the specified stream.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Stream_GetTagField(FSOUND_STREAM, int, IntBuffer, Pointer, Pointer, IntBuffer)
	 */
	public static boolean FSOUND_Stream_GetNumTagFields(FSOUND_STREAM stream, IntBuffer num)
	{
		if(num != null && !num.isDirect()) {
			throw new NonDirectBufferException();
		}
		return FmodJNI.FSOUND_Stream_GetNumTagFields(Pointer.getPointer(stream), num, BufferUtils.getPositionInBytes(num));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Stream_FindTagField(FSOUND_STREAM, int, String, Pointer, IntBuffer)
	 * @see Fmod#FSOUND_Stream_GetNumTagFields(FSOUND_STREAM, IntBuffer)
	 * @see FSOUND_TAGFIELD_TYPE
	 */
	public static boolean FSOUND_Stream_GetTagField(FSOUND_STREAM stream, int num,
			int[] type, Pointer name, Pointer value, int[] length)
	{
		boolean result = FmodJNI.FSOUND_Stream_GetTagField(Pointer.getPointer(stream),
	 ...
	 */
	public static boolean FSOUND_Stream_GetTagField(FSOUND_STREAM stream, int num,
			IntBuffer type, Pointer name, Pointer value, IntBuffer length)
	{
		...
		boolean result = FmodJNI.FSOUND_Stream_GetTagField(Pointer.getPointer(stream), num, type, BufferUtils.getPositionInBytes(type),
				name, value,
	 ...
	 * @see FSOUND_TAGFIELD_TYPE
	 */
	public static boolean FSOUND_Stream_FindTagField(FSOUND_STREAM stream, int type, String name,
			Pointer value, int[] length)
	{
		return FmodJNI.FSOUND_Stream_FindTagField(Pointer.getPointer(stream),
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_SetProxy(String proxy)
	{
		return FmodJNI.FSOUND_Stream_Net_SetProxy(proxy);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_SetTimeout(int timeout)
	{
		return FmodJNI.FSOUND_Stream_Net_SetTimeout(timeout);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static String FSOUND_Stream_Net_GetLastServerStatus()
	{
		return FmodJNI.FSOUND_Stream_Net_GetLastServerStatus();
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_SetBufferProperties(int buffersize, int prebuffer_percent,
			int rebuffer_percent)
	{
		return FmodJNI.FSOUND_Stream_Net_SetBufferProperties(buffersize, prebuffer_percent,
				rebuffer_percent);
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_GetBufferProperties(int[] buffersize,
			int[] prebuffer_percent, int[] rebuffer_percent)
	{
		return FmodJNI.FSOUND_Stream_Net_GetBufferProperties(buffersize, prebuffer_percent, rebuffer_percent);
	}
	/**
	 * Gets buffer size and thresholds that will be used when opening new internet streams.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_GetBufferProperties(IntBuffer buffersize,
			IntBuffer prebuffer_percent, IntBuffer rebuffer_percent)
	{
		...
		return FmodJNI.FSOUND_Stream_Net_GetBufferProperties(buffersize, BufferUtils.getPositionInBytes(buffersize),
	 ...
	 */
	//TODO userdata
	public static boolean FSOUND_Stream_Net_SetMetadataCallback(FSOUND_STREAM stream,
			FSOUND_METADATACALLBACK callback, Pointer userdata)
	{
		return FmodJNI.FSOUND_Stream_Net_SetMetadataCallback(Pointer.getPointer(stream),
				callback, Pointer.getPointer(userdata));
	}
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_GetStatus(FSOUND_STREAM stream, int[] status,
			int[] bufferpercentused, int[] bitrate, int[] flags)
	{
		return FmodJNI.FSOUND_Stream_Net_GetStatus(Pointer.getPointer(stream),
				status, bufferpercentused, bitrate, flags);
	}
	/**
	 * Get various status information for an internet stream.<br>
	 * <br><b>Remarks :</b><br>
	 ...
	 * @see Fmod#FSOUND_Stream_Stop(FSOUND_STREAM)
	 */
	public static boolean FSOUND_Stream_Net_GetStatus(FSOUND_STREAM stream, IntBuffer status,
			IntBuffer bufferpercentused, IntBuffer bitrate, IntBuffer flags)
	{
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_CD_GetVolume(char)
	 * @see Fmod#FSOUND_CD_SetPlayMode(char, byte)
	 * @see Fmod#FSOUND_CD_SetVolume(char, int)
	 * @see Fmod#FSOUND_CD_Stop(char)
	 */
	public static boolean FSOUND_CD_Play(char drive, int track)
	{
		return FmodJNI.FSOUND_CD_Play(drive, track);
	}
	 ...
	 * @see Fmod#FSOUND_CD_Play(char, int)
	 * @see FSOUND_CDPLAYMODES
	 */
	public static void FSOUND_CD_SetPlayMode(char drive, byte mode)
	{
		FmodJNI.FSOUND_CD_SetPlayMode(drive, mode);
	}
	...
	{
		return FmodJNI.FSOUND_CD_Stop(drive);
	}
	 ...
	 * On failure, FALSE is returned.
	 */
	public static boolean FSOUND_CD_SetPaused(char drive, boolean paused)
	{
		return FmodJNI.FSOUND_CD_SetPaused(drive, paused);
	}
	 ...
	 * @see Fmod#FSOUND_Close()
	 */
	public static boolean FSOUND_CD_SetVolume(char drive, int volume)
	{
		return FmodJNI.FSOUND_CD_SetVolume(drive, volume);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_CD_GetTrackLength(char, int)
	 * @see Fmod#FSOUND_CD_GetTrackTime(char)
	 */
	public static boolean FSOUND_CD_SetTrackTime(char drive, int ms)
	{
		return FmodJNI.FSOUND_CD_SetTrackTime(drive, ms);
	}
	...
	{
		return FmodJNI.FSOUND_CD_GetPaused(drive);
	}
	 ...
	 * On failure, 0 is returned.
	 * @see Fmod#FSOUND_CD_GetNumTracks(char)
	 */
	public static int FSOUND_CD_GetTrack(char drive)
	{
		return FmodJNI.FSOUND_CD_GetTrack(drive);
	}
	 ...
	 * On failure, 0 is returned.
	 * @see Fmod#FSOUND_CD_GetTrack(char)
	 */
	public static int FSOUND_CD_GetNumTracks(char drive)
	{
		return FmodJNI.FSOUND_CD_GetNumTracks(drive);
	}
	 ...
	 * On failure, -1 is returned.
	 * @see Fmod#FSOUND_CD_GetTrackLength(char, int)
	 * @see Fmod#FSOUND_CD_SetTrackTime(char, int)
	 */
	public static int FSOUND_CD_GetVolume(char drive)
	{
		return FmodJNI.FSOUND_CD_GetVolume(drive);
	}
	 ...
	 */
	public static boolean FSOUND_CD_OpenTray(char drive, boolean open)
	{
		return FmodJNI.FSOUND_CD_OpenTray(drive, open);
	}
	 ...
	 * @see Fmod#FSOUND_CD_SetTrackTime(char, int)
	 */
	public static int FSOUND_CD_GetTrackLength(char drive, int track)
	{
		return FmodJNI.FSOUND_CD_GetTrackLength(drive, track);
	}
	...
	{
		return FmodJNI.FSOUND_CD_GetTrackTime(drive);
	}
	 ...
	 * On failure, NULL is returned.
	 * @see Fmod#FSOUND_DSP_Create(FSOUND_DSPCALLBACK, int, Pointer)
	 * @see Fmod#FSOUND_DSP_Free(FSOUND_DSPUNIT)
	 * @see Fmod#FSOUND_DSP_GetBufferLength()
	 * @see Fmod#FSOUND_DSP_GetBufferLengthTotal()
	 * @see Fmod#FSOUND_DSP_MixBuffers(ByteBuffer, ByteBuffer, int, int, int, int, int)
	 * @see FSOUND_DSP_PRIORITIES
	 * @see Fmod#FSOUND_DSP_SetActive(FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_DSP_SetPriority(FSOUND_DSPUNIT, int)
	 * @see FSOUND_DSPCALLBACK
	 * @see Fmod#FSOUND_GetCPUUsage()
	 * @see Fmod#FSOUND_GetMixer()
	 * @see FSOUND_MIXERTYPES
	 * @see Fmod#FSOUND_PlaySoundEx(int, FSOUND_SAMPLE, FSOUND_DSPUNIT, boolean)
	 * @see Fmod#FSOUND_Stream_CreateDSP(FSOUND_STREAM, FSOUND_DSPCALLBACK, int, Pointer)
	 */
	//TODO userdata
	public static FSOUND_DSPUNIT FSOUND_DSP_Create(
			FSOUND_DSPCALLBACK callback, int priority, Pointer userdata)
	{
		long cPtr = FmodJNI.FSOUND_DSP_Create(callback, priority, Pointer.getPointer(userdata));
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_Create(FSOUND_DSPCALLBACK, int, Pointer)
	 */
	public static void FSOUND_DSP_Free(FSOUND_DSPUNIT unit)
	{
		FmodJNI.FSOUND_DSP_Free(Pointer.getPointer(unit));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_Create(FSOUND_DSPCALLBACK, int, Pointer)
	 * @see Fmod#FSOUND_DSP_GetPriority(FSOUND_DSPUNIT)
	 */
	public static void FSOUND_DSP_SetPriority(FSOUND_DSPUNIT unit, int priority)
	{
		FmodJNI.FSOUND_DSP_SetPriority(Pointer.getPointer(unit), priority);
	}
	 ...
	 * @see Fmod#FSOUND_DSP_SetPriority(FSOUND_DSPUNIT, int)
	 */
	public static int FSOUND_DSP_GetPriority(FSOUND_DSPUNIT unit)
	{
		return FmodJNI.FSOUND_DSP_GetPriority(Pointer.getPointer(unit));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_ClearMixBuffer()
	 * @see Fmod#FSOUND_DSP_Create(FSOUND_DSPCALLBACK, int, Pointer)
	 * @see Fmod#FSOUND_DSP_GetActive(FSOUND_DSPUNIT)
	 * @see Fmod#FSOUND_DSP_GetSpectrum()
	 */
	public static void FSOUND_DSP_SetActive(FSOUND_DSPUNIT unit, boolean active)
	{
		FmodJNI.FSOUND_DSP_SetActive(Pointer.getPointer(unit), active);
	}
	 ...
	 * @see Fmod#FSOUND_DSP_SetActive(FSOUND_DSPUNIT, boolean)
	 */
	public static boolean FSOUND_DSP_GetActive(FSOUND_DSPUNIT unit)
	{
		return FmodJNI.FSOUND_DSP_GetActive(Pointer.getPointer(unit));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_GetClipAndCopyUnit()
	 * @see Fmod#FSOUND_DSP_GetFFTUnit()
	 * @see Fmod#FSOUND_DSP_GetMusicUnit()
	 * @see Fmod#FSOUND_DSP_GetSFXUnit()
	 */
	public static FSOUND_DSPUNIT FSOUND_DSP_GetClearUnit()
	{
		long cPtr = FmodJNI.FSOUND_DSP_GetClearUnit();
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @return Pointer to the DSP unit.
	 * @see Fmod#FSOUND_DSP_ClearMixBuffer()
	 * @see Fmod#FSOUND_DSP_GetClearUnit()
	 * @see Fmod#FSOUND_DSP_GetClipAndCopyUnit()
	 * @see Fmod#FSOUND_DSP_GetFFTUnit()
	 * @see Fmod#FSOUND_DSP_GetMusicUnit()
	 */
	public static FSOUND_DSPUNIT FSOUND_DSP_GetSFXUnit()
	{
		long cPtr = FmodJNI.FSOUND_DSP_GetSFXUnit();
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_GetSFXUnit()
	 */
	public static FSOUND_DSPUNIT FSOUND_DSP_GetMusicUnit()
	{
		long cPtr = FmodJNI.FSOUND_DSP_GetMusicUnit();
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_GetSpectrum()
	 */
	public static FSOUND_DSPUNIT FSOUND_DSP_GetFFTUnit()
	{
		long cPtr = FmodJNI.FSOUND_DSP_GetFFTUnit();
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_DSP_GetSFXUnit()
	 */
	public static FSOUND_DSPUNIT FSOUND_DSP_GetClipAndCopyUnit()
	{
		long cPtr = FmodJNI.FSOUND_DSP_GetClipAndCopyUnit();
		return (cPtr == 0) ? null : FSOUND_DSPUNIT.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FSOUND_SetVolume(int, int)
	 */
	public static boolean FSOUND_DSP_MixBuffers(ByteBuffer destbuffer, ByteBuffer srcbuffer, int len,
			int freq, int vol, int pan, int mode)
	{
		...
		return FmodJNI.FSOUND_DSP_MixBuffers(destbuffer, BufferUtils.getPositionInBytes(destbuffer), srcbuffer, BufferUtils.getPositionInBytes(srcbuffer), len, freq, vol, pan, mode);
	}
	...
	{
		FmodJNI.FSOUND_DSP_ClearMixBuffer();
	}
	...
	{
		return FmodJNI.FSOUND_DSP_GetBufferLength();
	}
	...
	{
		return FmodJNI.FSOUND_DSP_GetBufferLengthTotal();
	}
	...
	{
		ByteBuffer buffer = FmodJNI.FSOUND_DSP_GetSpectrum();
		if(buffer != null)
		{
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Reverb_GetChannelProperties(int, FSOUND_REVERB_CHANNELPROPERTIES)
	 * @see Fmod#FSOUND_Reverb_GetProperties(FSOUND_REVERB_PROPERTIES)
	 * @see FSOUND_REVERB_PROPERTIES
	 * @see Fmod#FSOUND_Reverb_SetChannelProperties(int, FSOUND_REVERB_CHANNELPROPERTIES)
	 */
	public static boolean FSOUND_Reverb_SetProperties(FSOUND_REVERB_PROPERTIES prop)
	{
		return FmodJNI.FSOUND_Reverb_SetProperties(Pointer.getPointer(prop));
	}
	 ...
	 * @see FSOUND_REVERB_PROPERTIES
	 * @see Fmod#FSOUND_Reverb_SetChannelProperties(int, FSOUND_REVERB_CHANNELPROPERTIES)
	 * @see Fmod#FSOUND_Reverb_SetProperties(FSOUND_REVERB_PROPERTIES)
	 */
	public static boolean FSOUND_Reverb_GetProperties(FSOUND_REVERB_PROPERTIES prop)
	{
		return FmodJNI.FSOUND_Reverb_GetProperties(Pointer.getPointer(prop));
	}
	...
	{
		return FmodJNI.FSOUND_Reverb_SetChannelProperties(channel,
	...
	public static boolean FSOUND_Reverb_GetChannelProperties(int channel,
			FSOUND_REVERB_CHANNELPROPERTIES prop)
	{
		return FmodJNI.FSOUND_Reverb_GetChannelProperties(channel,
				Pointer.getPointer(prop));
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_Record_GetDriver()
	 * @see Fmod#FSOUND_Record_GetDriverName(int)
	 * @see Fmod#FSOUND_Record_GetNumDrivers()
	 */
	public static boolean FSOUND_Record_SetDriver(int outputtype)
	{
		return FmodJNI.FSOUND_Record_SetDriver(outputtype);
	}
	 ...
	 * @see Fmod#FSOUND_Record_GetDriver()
	 * @see Fmod#FSOUND_Record_GetDriverName(int)
	 * @see Fmod#FSOUND_Record_SetDriver(int)
	 */
	public static int FSOUND_Record_GetNumDrivers()
	{
		return FmodJNI.FSOUND_Record_GetNumDrivers();
	}
	 ...
	 * @see Fmod#FSOUND_Record_SetDriver(int)
	 */
	public static String FSOUND_Record_GetDriverName(int id)
	{
		return FmodJNI.FSOUND_Record_GetDriverName(id);
	}
	...
	{
		return FmodJNI.FSOUND_Record_GetDriver();
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetCurrentPosition(int)
	 * @see Fmod#FSOUND_Record_GetPosition()
	 * @see Fmod#FSOUND_Record_Stop()
	 */
	public static boolean FSOUND_Record_StartSample(FSOUND_SAMPLE sptr, boolean loop)
	{
		return FmodJNI.FSOUND_Record_StartSample(Pointer.getPointer(sptr), loop);
	}
	...
	{
		return FmodJNI.FSOUND_Record_Stop();
	}
	...
	{
		return FmodJNI.FSOUND_Record_GetPosition();
	}
	 ...
	 * On failure, NULL is returned.
	 * @see Fmod#FMUSIC_FreeSong(FMUSIC_MODULE)
	 * @see Fmod#FMUSIC_LoadSong(String)
	 * @see Fmod#FMUSIC_LoadSongEx(String, int, int, int, IntBuffer, int)
	 * @see Fmod#FSOUND_File_SetCallbacks(FSOUND_OPENCALLBACK, FSOUND_CLOSECALLBACK, FSOUND_READCALLBACK, FSOUND_SEEKCALLBACK, FSOUND_TELLCALLBACK)
	 */
	public static FMUSIC_MODULE FMUSIC_LoadSong(String name)
	{
		long cPtr = FmodJNI.FMUSIC_LoadSong(name);
	 ...
	 * @see Fmod#FMUSIC_LoadSong(String)
	 */
	public static FMUSIC_MODULE FMUSIC_LoadSongEx(String name, int offset, int length,
			int mode, int[] samplelist, int samplelistnum)
	{
		long cPtr = FmodJNI.FMUSIC_LoadSongEx(name, offset, length, mode, samplelist, samplelistnum);
		return (cPtr == 0) ? null : FMUSIC_MODULE.createView(Pointer.newPointer(cPtr));
	}
	/**
	 * To load a module or bank with a given filename. FMUSIC Supports loading of <br>
	 ...
	 */
	public static FMUSIC_MODULE FMUSIC_LoadSongEx(String name, int offset, int length,
			int mode, IntBuffer samplelist, int samplelistnum)
	{
		if(samplelist != null && !samplelist.isDirect()) {
			throw new NonDirectBufferException();
		}
		long cPtr = FmodJNI.FMUSIC_LoadSongEx(name, offset, length, mode, samplelist, BufferUtils.getPositionInBytes(samplelist), samplelistnum);
		return (cPtr == 0) ? null : FMUSIC_MODULE.createView(Pointer.newPointer(cPtr));
	}
	/**
	 * To load a module or bank with a given filename. FMUSIC Supports loading of <br>
	 ...
	 * ___________________<br>
	 * Supported on the following platforms : Win32, WinCE, Linux, Macintosh, XBox, PlayStation2, GameCube
	 * @param data Pointer to data containing song to load (if loading from memory and not file).<br>
	 ...
	 * @see Fmod#FMUSIC_LoadSong(String)
	 */
	public static FMUSIC_MODULE FMUSIC_LoadSongEx(ByteBuffer data, int offset, int length,
			int mode, int[] samplelist, int samplelistnum)
	{
		if(data != null && !data.isDirect()) {
			throw new NonDirectBufferException();
		}
		long cPtr = FmodJNI.FMUSIC_LoadSongEx(data, BufferUtils.getPositionInBytes(data), offset, length, mode, samplelist, samplelistnum);
		return (cPtr == 0) ? null : FMUSIC_MODULE.createView(Pointer.newPointer(cPtr));
	}
	/**
	 * To load a module or bank with a given filename. FMUSIC Supports loading of <br>
			...
			int mode, IntBuffer samplelist, int samplelistnum)
	{
		...
		long cPtr = FmodJNI.FMUSIC_LoadSongEx(data, BufferUtils.getPositionInBytes(data), offset, length, mode, samplelist, BufferUtils.getPositionInBytes(samplelist), samplelistnum);
		return (cPtr == 0) ? null : FMUSIC_MODULE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 */
	public static int FMUSIC_GetOpenState(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetOpenState(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_LoadSongEx(String, int, int, int, IntBuffer, int)
	 */
	public static boolean FMUSIC_FreeSong(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_FreeSong(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_IsPlaying(FMUSIC_MODULE)
	 * @see Fmod#FMUSIC_SetLooping(FMUSIC_MODULE, boolean)
	 * @see Fmod#FMUSIC_StopAllSongs()
	 * @see Fmod#FMUSIC_StopSong(FMUSIC_MODULE)
	 */
	public static boolean FMUSIC_PlaySong(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_PlaySong(Pointer.getPointer(mod));
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_PlaySong(FMUSIC_MODULE)
	 * @see Fmod#FMUSIC_StopAllSongs()
	 */
	public static boolean FMUSIC_StopSong(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_StopSong(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, FALSE is returned.
	 * @see FMUSIC_CALLBACK
	 * @see Fmod#FMUSIC_SetInstCallback(FMUSIC_MODULE, FMUSIC_CALLBACK, int)
	 * @see Fmod#FMUSIC_SetOrderCallback(FMUSIC_MODULE, FMUSIC_CALLBACK, int)
	 * @see Fmod#FMUSIC_SetRowCallback(FMUSIC_MODULE, FMUSIC_CALLBACK, int)
	 */
	public static boolean FMUSIC_SetZxxCallback(FMUSIC_MODULE mod,
			FMUSIC_CALLBACK callback)
	{
		return FmodJNI.FMUSIC_SetZxxCallback(Pointer.getPointer(mod),
				callback);
	}
	 ...
	 * @see Fmod#FMUSIC_SetInstCallback(FMUSIC_MODULE, FMUSIC_CALLBACK, int)
	 * @see Fmod#FMUSIC_SetOrderCallback(FMUSIC_MODULE, FMUSIC_CALLBACK, int)
	 * @see Fmod#FMUSIC_SetZxxCallback(FMUSIC_MODULE, FMUSIC_CALLBACK)
	 */
	public static boolean FMUSIC_SetRowCallback(FMUSIC_MODULE mod,
			FMUSIC_CALLBACK callback, int rowstep)
	{
		return FmodJNI.FMUSIC_SetRowCallback(Pointer.getPointer(mod), callback, rowstep);
	}
	 ...
	 * @see Fmod#FMUSIC_SetZxxCallback(FMUSIC_MODULE, FMUSIC_CALLBACK)
	 */
	public static boolean FMUSIC_SetOrderCallback(FMUSIC_MODULE mod,
			FMUSIC_CALLBACK callback, int orderstep)
	{
		return FmodJNI.FMUSIC_SetOrderCallback(Pointer.getPointer(mod),
				callback, orderstep);
	}
	 ...
	 * @see Fmod#FMUSIC_SetZxxCallback(FMUSIC_MODULE, FMUSIC_CALLBACK)
	 */
	public static boolean FMUSIC_SetInstCallback(FMUSIC_MODULE mod,
			FMUSIC_CALLBACK callback, int instrument)
	{
		return FmodJNI.FMUSIC_SetInstCallback(Pointer.getPointer(mod),
				callback, instrument);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_GetSample(FMUSIC_MODULE, int)
	 */
	public static boolean FMUSIC_SetSample(FMUSIC_MODULE mod, int sampno, FSOUND_SAMPLE sptr)
	{
		return FmodJNI.FMUSIC_SetSample(Pointer.getPointer(mod), sampno, Pointer.getPointer(sptr));
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_GetUserData(FMUSIC_MODULE)
	 */
	//TODO userdata
	public static boolean FMUSIC_SetUserData(FMUSIC_MODULE mod, Pointer userdata)
	{
		return FmodJNI.FMUSIC_SetUserData(Pointer.getPointer(mod), Pointer.getPointer(userdata));
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FSOUND_GetChannelsPlaying()
	 */
	public static boolean FMUSIC_OptimizeChannels(FMUSIC_MODULE mod, int maxchannels, int minvolume)
	{
		return FmodJNI.FMUSIC_OptimizeChannels(Pointer.getPointer(mod), maxchannels,
				minvolume);
	}
	...
	{
		return FmodJNI.FMUSIC_SetReverb(reverb);
	}
	 ...
	 * @see Fmod#FMUSIC_PlaySong(FMUSIC_MODULE)
	 */
	public static boolean FMUSIC_SetLooping(FMUSIC_MODULE mod, boolean looping)
	{
		return FmodJNI.FMUSIC_SetLooping(Pointer.getPointer(mod), looping);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_GetOrder(FMUSIC_MODULE)
	 */
	public static boolean FMUSIC_SetOrder(FMUSIC_MODULE mod, int order)
	{
		return FmodJNI.FMUSIC_SetOrder(Pointer.getPointer(mod), order);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_GetPaused(FMUSIC_MODULE)
	 */
	public static boolean FMUSIC_SetPaused(FMUSIC_MODULE mod, boolean pause)
	{
		return FmodJNI.FMUSIC_SetPaused(Pointer.getPointer(mod), pause);
	}
	 ...
	 * @return On success, TRUE is returned.<br>
	 * On failure, FALSE is returned.
	 * @see Fmod#FMUSIC_GetGlobalVolume(FMUSIC_MODULE)
	 * @see Fmod#FMUSIC_GetMasterVolume(FMUSIC_MODULE)
	 * @see Fmod#FSOUND_GetSFXMasterVolume()
	 * @see Fmod#FSOUND_SetSFXMasterVolume(int)
	 */
	public static boolean FMUSIC_SetMasterVolume(FMUSIC_MODULE mod, int volume)
	{
		return FmodJNI.FMUSIC_SetMasterVolume(Pointer.getPointer(mod), volume);
	}
	 ...
	 * On failure, FALSE is returned.
	 */
	public static boolean FMUSIC_SetMasterSpeed(FMUSIC_MODULE mod, float speed)
	{
		return FmodJNI.FMUSIC_SetMasterSpeed(Pointer.getPointer(mod), speed);
	}
	 ...
	 * @see Fmod#FSOUND_SetPanSeperation(float)
	 */
	public static boolean FMUSIC_SetPanSeperation(FMUSIC_MODULE mod, float pansep)
	{
		return FmodJNI.FMUSIC_SetPanSeperation(Pointer.getPointer(mod), pansep);
	}
	 ...
	 */
	public static String FMUSIC_GetName(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetName(Pointer.getPointer(mod));
	}
	 ...
	 * @see FMUSIC_TYPES
	 */
	public static int FMUSIC_GetType(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetType(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static int FMUSIC_GetNumOrders(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetNumOrders(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static int FMUSIC_GetNumPatterns(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetNumPatterns(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static int FMUSIC_GetNumInstruments(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetNumInstruments(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static int FMUSIC_GetNumSamples(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetNumSamples(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, 0 is returned.
	 */
	public static int FMUSIC_GetNumChannels(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetNumChannels(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, NULL is returned.
	 * @see Fmod#FMUSIC_SetSample(FMUSIC_MODULE, int, FSOUND_SAMPLE)
	 */
	public static FSOUND_SAMPLE FMUSIC_GetSample(FMUSIC_MODULE mod, int sampno)
	{
		long cPtr = FmodJNI.FMUSIC_GetSample(Pointer.getPointer(mod), sampno);
		return (cPtr == 0) ? null : FSOUND_SAMPLE.createView(Pointer.newPointer(cPtr));
	}
	 ...
	 * @see Fmod#FMUSIC_GetOrder(FMUSIC_MODULE)
	 */
	public static int FMUSIC_GetPatternLength(FMUSIC_MODULE mod, int orderno)
	{
		return FmodJNI.FMUSIC_GetPatternLength(Pointer.getPointer(mod), orderno);
	}
	 ...
	 */
	public static boolean FMUSIC_IsFinished(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_IsFinished(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_PlaySong(FMUSIC_MODULE)
	 */
	public static boolean FMUSIC_IsPlaying(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_IsPlaying(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_SetMasterVolume(FMUSIC_MODULE, int)
	 */
	public static int FMUSIC_GetMasterVolume(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetMasterVolume(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_SetMasterVolume(FMUSIC_MODULE, int)
	 */
	public static int FMUSIC_GetGlobalVolume(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetGlobalVolume(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, -1 is returned.
	 * @see Fmod#FMUSIC_GetPattern(FMUSIC_MODULE)
	 * @see Fmod#FMUSIC_GetPatternLength(FMUSIC_MODULE, int)
	 * @see Fmod#FMUSIC_SetOrder(FMUSIC_MODULE, int)
	 */
	public static int FMUSIC_GetOrder(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetOrder(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_GetOrder(FMUSIC_MODULE)
	 */
	public static int FMUSIC_GetPattern(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetPattern(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, -1 is returned.
	 * @see Fmod#FMUSIC_GetBPM(FMUSIC_MODULE)
	 */
	public static int FMUSIC_GetSpeed(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetSpeed(Pointer.getPointer(mod));
	}
	 ...
	 * on failure, -1 is returned.
	 * @see Fmod#FMUSIC_GetSpeed(FMUSIC_MODULE)
	 */
	public static int FMUSIC_GetBPM(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetBPM(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, -1 is returned.
	 */
	public static int FMUSIC_GetRow(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetRow(Pointer.getPointer(mod));
	}
	 ...
	 * @see Fmod#FMUSIC_SetPaused(FMUSIC_MODULE, boolean)
	 */
	public static boolean FMUSIC_GetPaused(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetPaused(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, -1 is returned.
	 */
	public static int FMUSIC_GetTime(FMUSIC_MODULE mod)
	{
		return FmodJNI.FMUSIC_GetTime(Pointer.getPointer(mod));
	}
	 ...
	 * On failure, -1 is returned.
	 */
	public static int FMUSIC_GetRealChannel(FMUSIC_MODULE mod, int modchannel)
	{
		return FmodJNI.FMUSIC_GetRealChannel(Pointer.getPointer(mod), modchannel);
	}
	 ...
	 * On failure, 0 is returned.
	 * @see Fmod#FMUSIC_SetUserData(FMUSIC_MODULE, Pointer)
	 */
	//TODO userdata
	public static Pointer FMUSIC_GetUserData(FMUSIC_MODULE mod)
	{
		long cPtr = FmodJNI.FMUSIC_GetUserData(Pointer.getPointer(mod));
		return (cPtr == 0) ? null : Pointer.newPointer(cPtr);
	}
	...
	{
		return FmodJNI.FMOD_ErrorString(errcode);
	}
}