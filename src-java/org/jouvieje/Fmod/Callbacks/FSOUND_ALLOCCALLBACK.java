 ...
 */
public interface FSOUND_ALLOCCALLBACK
{
	/**
	 * Callback to allocate a block of memory.
	 * @param size Size in bytes of the memory block to be allocated and returned.
	 * @return On success, a pointer to the newly allocated block of memory is returned.
