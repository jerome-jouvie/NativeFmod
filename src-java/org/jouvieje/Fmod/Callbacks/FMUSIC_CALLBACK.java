 ...
 */
public interface FMUSIC_CALLBACK
{
	/**
	 * Callback definition for FMUSIC callbacks (mod/s3m/xm/it).
	 * @param mod The music file to have callbacks performed on.
	 * @param param The argument relating specifically to the callback made, whether it is a row/order or Zxx callback.
	 * For example on the row callback, the row number would be returned.
	 */
